...
[filterInv1AAFit,filterInv1AATau] = Anishkin_fit(filterInv1Pair,.052,Init);
...
[filterInv2AAFit,filterInv2AATau] = Anishkin_fit(filterInv2Pair,.052,Init);
...
[filterInv4AAFit,filterInv4AATau] = Anishkin_fit(filterInv4Pair,.052,Init);
...
[filterInv5_1_AAFit,filterInv5_1_AATau] = Anishkin_fit(filterInv5_1_Pair,.052,Init);
...
[filterInv5_2_AAFit,filterInv5_2_AATau] = Anishkin_fit(filterInv5_2_Pair,.052,Init);
...
[filterInv5_4_AAFit,filterInv5_4_AATau] = Anishkin_fit(filterInv5_4_Pair,.052,Init);
...
[filterInv1_1_AAFit,filterInv1_1_AATau] = Anishkin_fit(filterInv1_1_Pair,.052,Init);
...
[filterInv1_2_AAFit,filterInv1_2_AATau] = Anishkin_fit(filterInv1_2_Pair,.052,Init);
...
[filterInv1_4_AAFit,filterInv1_4_AATau] = Anishkin_fit(filterInv1_4_Pair,.052,Init);
filterInv1_4_2ExpFit = exp2Fit(filterInv1_4_Pair);

%% Write to Excel
dest = 'C:\Users\sukharevlab\Documents\Schams\Stopped Flow\All Data\Anishkin Fit Files\Tau\08-17-16 FRAG1 Constants Haar Transform.xlsx';
% 
